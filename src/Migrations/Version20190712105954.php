 ...
 */
final class Version20190712105954 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__route AS SELECT id, route_from_id_id, route_to_id_id, user_id, route_interval, route_notification_id FROM route');
        $this->addSql('DROP TABLE route');
        $this->addSql('CREATE TABLE route (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, route_from_id_id INTEGER NOT NULL, route_to_id_id INTEGER NOT NULL, user_id INTEGER NOT NULL, route_notification_id INTEGER DEFAULT NULL, route_interval TIME NOT NULL, CONSTRAINT FK_2C42079484571AF FOREIGN KEY (route_from_id_id) REFERENCES station (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2C420798A54E74C FOREIGN KEY (route_to_id_id) REFERENCES station (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_2C42079A76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO route (id, route_from_id_id, route_to_id_id, user_id, route_interval, route_notification_id) SELECT id, route_from_id_id, route_to_id_id, user_id, route_interval, route_notification_id FROM __temp__route');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_2C420798A54E74C');
        $this->addSql('DROP INDEX IDX_2C42079A76ED395');
        $this->addSql('CREATE TEMPORARY TABLE __temp__route AS SELECT id, route_from_id_id, route_to_id_id, user_id, route_notification_id, route_interval FROM route');
        $this->addSql('DROP TABLE route');
        $this->addSql('CREATE TABLE route (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, route_from_id_id INTEGER NOT NULL, route_to_id_id INTEGER NOT NULL, user_id INTEGER NOT NULL, route_notification_id INTEGER DEFAULT NULL, route_interval INTEGER NOT NULL)');
        $this->addSql('INSERT INTO route (id, route_from_id_id, route_to_id_id, user_id, route_notification_id, route_interval) SELECT id, route_from_id_id, route_to_id_id, user_id, route_notification_id, route_interval FROM __temp__route');
        $this->addSql('DROP TABLE __temp__route');
        $this->addSql('CREATE INDEX IDX_2C42079484571AF ON route (route_from_id_id)');
        $this->addSql('CREATE INDEX IDX_2C420798A54E74C ON route (route_to_id_id)');
        $this->addSql('CREATE INDEX IDX_2C42079A76ED395 ON route (user_id)');
